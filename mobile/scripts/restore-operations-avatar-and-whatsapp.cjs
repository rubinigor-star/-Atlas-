...
for (const { name, oldText, newText } of replacements) {
  ...
  if (!source.includes(newText)) {
    throw new Error(`Could not find old or new ${name} block in EventOperationsScreen.tsx`);
  }
}
