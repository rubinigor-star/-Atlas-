  ...
  return <main className="container" style={{maxWidth:760,paddingTop:48,paddingBottom:80}}>
    <div className="panel form" style={{padding:32}}>
      ...
      <form method="post" action="/api/office/auth/register" className="form">
        ...
        <label className="option"><span><strong>Я принимаю условия Atlas One</strong><small>Подтверждаю достоверность данных и согласие с правилами платформы и политикой конфиденциальности.</small></span><input type="checkbox" name="acceptedTerms" required /></label>
