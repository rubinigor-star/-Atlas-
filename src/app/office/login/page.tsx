  ...
  return <main className={styles.page}>
    <section className={styles.card}>
      <header className={styles.brand}>
        <div className={styles.logoLockup} aria-label="Atlas One Backstage">
          <img className={styles.logo} src="/atlas-one-logo.svg" alt="Atlas One" />
          <span className={styles.backstage}>Backstage</span>
        </div>
