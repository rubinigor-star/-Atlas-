...
export default async function Admin() {
  ...
  return <AdminShell>
    ...
    <div className="row between"><h2 className="section-title">Мероприятия</h2><Link href="/office/events">Все мероприятия →</Link></div>
