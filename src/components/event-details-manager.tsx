...
const labels = {
  ru: {
    ...
    galleryCheck: "Добавить фотографии 4:3 в галерею",
    galleryHelp: "До 6 горизонтальных фотографий 4:3. Рекомендуемый размер: 1600 × 1200 px. Максимальный вес: 1 МБ каждая. Без автоматической обрезки и изменения размера.",
  ...
  he: {
    ...
    galleryCheck: "הוספת תמונות 4:3 לגלריה",
    galleryHelp: "עד 6 תמונות אופקיות ביחס 4:3. גודל מומלץ: 1600 × 1200 פיקסלים. משקל מרבי: 1MB לכל תמונה. ללא חיתוך או שינוי גודל אוטומטי.",
  ...
  en: {
    ...
    galleryCheck: "Add 4:3 photos to the gallery",
    galleryHelp: "Up to 6 horizontal 4:3 photos. Recommended size: 1600 × 1200 px. Maximum file size: 1 MB each. No automatic cropping or resizing.",
