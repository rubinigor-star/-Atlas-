...
export function PromoterChannelTracker(){
 ...
 useEffect(()=>{
  ...
  document.cookie=`atlas_promoter_channel=${encodeURIComponent(normalized)}; Max-Age=1800; Path=/; SameSite=Lax`;
  const sessionId=sessionFor(normalized);let cancelled=false;
