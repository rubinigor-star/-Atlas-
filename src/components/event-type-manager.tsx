...
export function EventTypeManager({eventId,initialTypes,embedded=false}:{eventId:string;initialTypes:EventType[];embedded?:boolean}){
 ...
 return <section className={`${styles.panel} ${embedded?styles.embedded:styles.standalone}`} data-event-type-manager="true">
