...
const copy={
  ru:{runtime:"Продолжительность",venue:"Зал",categories:"Категории",age:"Возраст",startDate:"Дата начала",notSet:"Не указано",hours:"ч",minutes:"мин",noIntermission:"без антракта",oneIntermission:"включая 1 антракт",manyIntermissions:"антракта"},
  he:{runtime:"משך האירוע",venue:"אולם",categories:"קטגוריות",age:"גיל",startDate:"תאריך התחלה",notSet:"לא צוין",hours:"ש׳",minutes:"דק׳",noIntermission:"ללא הפסקה",oneIntermission:"כולל הפסקה אחת",manyIntermissions:"הפסקות"},
  en:{runtime:"Run time",venue:"Venue",categories:"Categories",age:"Age",startDate:"Start date",notSet:"Not specified",hours:"hr",minutes:"min",noIntermission:"No intermission",oneIntermission:"Incl. 1 intermission",manyIntermissions:"intermissions"},
} as const;
