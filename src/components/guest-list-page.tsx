...
type ActionResponse={error?:string;emailQueued?:boolean;publicId?:string;status?:string};
...
export function GuestListPage({code,token,title,eventTitle,allocation,limit,guestCount,guests,canManage,showAttendees,fields}:{code:string;token:string;title:string;eventTitle:string;allocation:string;limit:number;guestCount:number;guests:Guest[];canManage:boolean;showAttendees:boolean;fields:GuestFieldConfig}){
