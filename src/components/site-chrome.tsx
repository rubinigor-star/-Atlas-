      ...
      <div className="shell nav">
        ...
        <nav className="navlinks">
          ...
          <label className="language-switch" style={{ display: "inline-flex", alignItems: "center", gap: 7 }}>
            ...
            <select aria-label={messages.common.language} value={locale} onChange={(event) => setLocale(event.target.value as Locale)} style={{ border: 0, background: "transparent", color: "inherit", font: "inherit", fontWeight: 700, cursor: "pointer", outline: "none" }}>
...
export function SiteFooter() {
  ...
  return <footer className="footer"><div className="shell row between"><AtlasLogo /><span>© 2026 Atlas One</span><span>{messages.common.testOnly}</span></div></footer>;
}
