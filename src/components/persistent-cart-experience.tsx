...
const copy = {
  ...
  he: {
    ...
    empty: "סל הקניות ריק",
    back: "חזרה לכרטיסים",
    close: "סגירת סל הקניות",
    saved: (title: string) => `${title}: המקומות נשמרים ל-15 דקות. השלימו את ההזמנה כדי לשמור אותם בסל הקניות.`,
    left: (title: string, minutes: number) => `${title}: נותרו ${minutes} דקות. השלימו את ההזמנה לפני שהכרטיסים יוסרו מסל הקניות.`,
    urgent: (title: string) => `${title}: 3 דקות אחרונות. בסיום הטיימר הכרטיסים יוסרו מסל הקניות והמקומות יחזרו למכירה.`,
    expired: (title: string) => `${title}: זמן השמירה הסתיים. הכרטיסים הוסרו מסל הקניות והמקומות חזרו למכירה.`,
    ...
    remove: "הסרת כרטיסים",
    removeTitle: "להסיר את הכרטיסים מסל הקניות?",
    removeExplain: "אפשר לעבור מיד לתשלום ולהשלים את הרכישה. אם תחזירו את הכרטיסים למכירה, הם יוסרו מסל הקניות והשמירה תבוטל.",
