...
const copy={
  ...
  en:{request:"Ticket request",checkout:"Checkout",reviewData:"Details for organizer review",contact:"Guest details",firstName:"First name",lastName:"Last name",birthDate:"Date of birth",city:"City",phone:"Phone",promo:"Promo code",extra:"Additional information for the organizer",extraPlaceholder:"For example, membership number or who invited you",promoPlaceholder:"For example, ATLAS10",reviewFirst:"Organizer review first",testPayment:"Test payment",reviewHelp:"The payment will be authorized now but not charged. After approval, the system will complete the test payment and issue the ticket.",paymentHelp:"This is a secure simulation. No real money is charged.",sending:"Sending…",send:"Authorize payment and submit request",confirm:"Complete test payment and get ticket",requested:"Requested ticket",order:"Your order",quantity:"Quantity",afterApproval:"Charged after approval",total:"Total",error:"Could not submit the details",promoter:"Personal link",paymentTitle:"Payment method",card:"Credit card",apple:"Apple Pay",google:"Google Pay",paypal:"PayPal",cardNumber:"Card number",cardholder:"Cardholder name",expiry:"Expiry",cvc:"CVC",testCards:"Success: 4242 4242 4242 4242 · Decline: 4000 0000 0000 0002"}
};
