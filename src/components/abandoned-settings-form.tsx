...
export function AbandonedSettingsForm() {
  ...
  return <div className="panel" style={{maxWidth:820}}>
    ...
    <div className="panel" style={{background:"#fff7ed",borderColor:"#fed7aa"}}><strong>Тестовый режим</strong><p className="muted" style={{marginBottom:0}}>Для проверки установите 1 минуту, сохраните настройки, пройдите checkout, закройте страницу, подождите полную минуту и нажмите «Обработать сейчас». Закрытие вкладки больше не является обязательным сигналом: сервер проверяет время последней активности.</p></div>
