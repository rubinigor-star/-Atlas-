...
export function AbandonedSettingsForm() {
  ...
  return <div className="panel" style={{maxWidth:820}}>
    ...
    <div className="panel" style={{background:"#fff7ed",borderColor:"#fed7aa"}}><strong>Тестовый режим</strong><p className="muted" style={{marginBottom:0}}>Для проверки можно установить 1 минуту. Перед Production верните безопасный интервал, например 30 минут.</p></div>
