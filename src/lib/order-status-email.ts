...
const requestCopy = {
  ru: {
    ...
    hello: "Здравствуйте",
    text: "Мы получили вашу заявку и передали её организатору на рассмотрение. Сумма заказа предварительно авторизована на вашей карте, но деньги ещё не списаны.",
    next: "Списание произойдёт только если организатор подтвердит заказ. После решения мы отправим отдельное письмо. При одобрении вы получите билеты, при отказе авторизация будет отменена.",
    order: "Заявка",
    open: "Открыть заявку",
  },
  he: {
    ...
    title: "הבקשה התקבלה",
    hello: "שלום",
    text: "קיבלנו את הבקשה שלך והעברנו אותה למפיק לבדיקה. סכום ההזמנה אושר מראש בכרטיס, אך עדיין לא חויב.",
    next: "החיוב יתבצע רק אם המפיק יאשר את ההזמנה. לאחר ההחלטה נשלח הודעה נוספת. במקרה של אישור הכרטיסים יישלחו אליך, ובמקרה של דחייה האישור המוקדם יבוטל.",
    order: "בקשה",
    open: "פתיחת הבקשה",
  },
  en: {
    ...
    hello: "Hello",
    text: "We received your request and sent it to the organizer for review. The order amount has been pre-authorized on your card, but no charge has been made yet.",
    next: "Your card will be charged only if the organizer approves the order. We will email you after the decision. If approved, you will receive your tickets; if declined, the authorization will be released.",
    order: "Request",
    open: "Open request",
  },
} as const;
