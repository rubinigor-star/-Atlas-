...
if(!src.includes('ATLAS_PAYMENT_LEGAL_NOTE')){
  ...
  const legal=`<><iframe ref={iframeRef} src={paymentUrl} title={text.payment} allow="payment" onLoad={handleFrameLoad} className={styles.paymentFrame}/><div className={styles.paymentLegal}>{locale==="he"?<span>ע״י לחיצה על כפתור התשלום אני מאשר/ת את <a href="/privacy" target="_blank" rel="noreferrer">מדיניות הפרטיות</a> ו<a href="/terms" target="_blank" rel="noreferrer">תנאי השימוש</a></span>:locale==="ru"?<span>Нажимая кнопку оплаты, я подтверждаю согласие с <a href="/privacy" target="_blank" rel="noreferrer">Политикой конфиденциальности</a> и <a href="/terms" target="_blank" rel="noreferrer">Условиями использования</a></span>:<span>By clicking the payment button, I agree to the <a href="/privacy" target="_blank" rel="noreferrer">Privacy Policy</a> and <a href="/terms" target="_blank" rel="noreferrer">Terms of Use</a></span>}</div></>`;
  if(!src.includes(iframe)) throw new Error('payment iframe anchor not found');
  src=src.replace(iframe,`{/* ATLAS_PAYMENT_LEGAL_NOTE */}${legal}`);
