...
// Keep the complete hosted HYP payment form visible. The provider is cross-origin,
// so the parent cannot reliably read its document height. A full 680px viewport
// matches the original hosted checkout and prevents an internal vertical scrollbar
// on desktop, tablet and mobile.
if(!css.includes('ATLAS_COMPACT_HYP_FOOTER')){
  css+=`\n/* ATLAS_COMPACT_HYP_FOOTER */\n.paymentCard{min-height:0!important}.paymentFrame{height:680px!important;min-height:680px!important}.paymentLegal{padding-top:4px!important}@media(max-width:900px){.paymentFrame{height:680px!important;min-height:680px!important}}@media(max-width:640px){.paymentFrame{height:680px!important;min-height:680px!important}}\n`;
}
