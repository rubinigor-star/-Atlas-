...
// Never crop or translate the cross-origin HYP document. Its internal layout
// changes by device and available wallet methods (for example Apple Pay on
// iPhone), so fixed viewport crops can hide controls, provider branding, or
// create an internal scrollbar. Keep the hosted payment page at its native
// viewport on desktop, tablet and mobile.
if(!css.includes('ATLAS_HYP_NATIVE_VIEWPORT')){
  css+=`\n/* ATLAS_HYP_NATIVE_VIEWPORT */\n.paymentCard{min-height:0!important;overflow:visible!important}.paymentFrame{width:100%!important;height:680px!important;min-height:680px!important;border:0!important;display:block!important;background:#fff!important;transform:none!important;overflow:hidden!important}.paymentLegal{padding-top:4px!important}@media(max-width:900px){.paymentFrame{height:680px!important;min-height:680px!important;transform:none!important}}@media(max-width:640px){.paymentFrame{height:680px!important;min-height:680px!important;transform:none!important}}\n`;
}
