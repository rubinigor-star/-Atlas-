...
const draftState=' /* ATLAS_CHECKOUT_DRAFT_MEMORY */ const checkoutDraftKey=`atlas-checkout-draft-v1:${props.eventId}:${props.eventSlug}`;const checkoutDraftLoadedRef=useRef(false);const checkoutDraftSkipSaveRef=useRef(true);';
